...
<body class="bg-gray-100">
    ...
    <main>
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row items-center md:space-x-6">
                    ...
                    <div class="text-center md:text-left md:w-1/2">
                        <h2 class="text-2xl font-bold mb-4 text-teal-800">Exámenes personalizados de inglés</h2>
        ...
        <section class="bg-teal-100 py-12">
            <div class="container mx-auto px-4">
                <h2 class="text-2xl font-bold text-center mb-6 text-teal-800">Características principales</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text
                        -xl font-bold mb-2 text-teal-800">Responsive</h3>
